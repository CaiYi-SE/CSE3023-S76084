...
public class PayrollServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        e2.setName("Lim Jun Kok"); 
        e2.setEmpId("E112");
        e2.setDepartment("Information Technology");
        e2.setBasicSalary(2000);
        
        Employee e3 = new Employee();
        e3.setName("Alessandra"); 
        e3.setEmpId("E113");
        e3.setDepartment("Finance");
        e3.setBasicSalary(3500);
        
        Employee e4 = new Employee();
        e4.setName("Kumar A/L Mutu"); 
        e4.setEmpId("E114");
        e4.setDepartment("Marketing");
        e4.setBasicSalary(2400);
        
        Employee e5 = new Employee();
        e5.setName("Alia Syamimi Binti Ahmad"); 
        e5.setEmpId("E115");
